...
(fact "running totals calculated for any race"
      (running-total results running-lay-total) => (contains [{:race_date 123455 :total 0.95M :finishes nil}
      ...
      (running-total results running-back-total) => (contains [{:race_date 123455 :total -1.0M :finishes nil}
...
(fact "chart data for running totals"
      (chart-data (running-total results running-lay-total)) => "{y : 0.95, finishes : []},{y : -1.05, finishes : []},{y : -0.10, finishes : []},{y : 0.85, finishes : []}"
      (chart-data (running-total results running-back-total)) => "{y : -1.0, finishes : []},{y : 0.5, finishes : []},{y : -0.5, finishes : []},{y : -1.5, finishes : []}"      
      )